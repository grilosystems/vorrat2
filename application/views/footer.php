...
?>
    <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small>Copyright © PugaSoft 2018</small>
        </div>
      </div>
    </footer>
    ...
    <script src="<?= base_url(); ?>guithem/vendor/chart.js/Chart.min.js"></script>
    <script src="<?= base_url(); ?>guithem/vendor/datatables/jquery.dataTables.js"></script>
    <script src="<?= base_url(); ?>guithem/vendor/datatables/dataTables.bootstrap4.js"></script>
    <!-- Custom scripts for all pages-->
    <script src="<?= base_url(); ?>guithem/js/sb-admin.min.js"></script>
